...
export default function Dashboard() {
  const quickActions = [
    ...
    {
      title: 'Анализ данных',
      description: 'Изучите статистику и аномалии данных',
      icon: BarChart3,
      link: '/analysis',
  ...
  const features = [
    ...
    {
      icon: Clock,
      title: 'Обработка табличных данных',
      description: 'Профессиональные инструменты для работы с табличными данными'
    }
  ]
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground mb-2">
          Добро пожаловать в систему прогнозирования табличных данных
        </h1>
        <p className="text-lg text-muted-foreground">
          Мощный инструмент для анализа и прогнозирования табличных данных
        </p>
      </div>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-center space-x-3">
              ...
              <span>Загрузите ваши табличные данные в формате CSV, Excel или подключитесь к базе данных</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold">2</div>
              <span>Настройте параметры модели: выберите целевую переменную и дополнительные параметры</span>
            </div>
            <div className="flex items-center space-x-3">
