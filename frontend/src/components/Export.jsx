...
export default function Export() {
  ...
  const [dbPanelOpen, setDbPanelOpen] = useState(true); // Панель всегда открыта или скрыта
  ...
  const handleDbConnect = async () => {
    ...
    try {
      ...
      if (result.success && result.access_token) {
        ...
        // Вместо fetch к /get-tables используем глобальную функцию
          ...
          <TabsContent value="database" className="space-y-6">
            ...
            {dbSaveError && (
              <Card className="bg-red-50 border-red-200">
                <CardContent className="py-4 flex items-center space-x-2">
                  <span className="text-red-600 font-medium">{dbSaveError}</span>
                </CardContent>
              </Card>
            )}
            <Card className="mt-0">
                    ...
                    dbTablesLoading ? (
                      <div className="flex items-center justify-center py-6">
                        ...
                        <div className="space-y-3 border-t pt-3">
                          ...
                          <div className="space-y-2">
                            {dbSaveMode === 'existing' || (dbSaveMode === 'new' && newTableName) ? (
